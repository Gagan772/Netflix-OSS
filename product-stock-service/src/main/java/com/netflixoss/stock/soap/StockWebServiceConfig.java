...
@EnableWs
@Configuration
public class StockWebServiceConfig extends WsConfigurerAdapter {

    private final SoapLoggingInterceptor soapLoggingInterceptor;

    public StockWebServiceConfig(SoapLoggingInterceptor soapLoggingInterceptor) {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema stockSchema) {
        ...
        wsdl11Definition.setTargetNamespace(StockSoapNamespace.URI);
    ...
    public XsdSchema stockSchema() {
        return new SimpleXsdSchema(new ClassPathResource("wsdl/stock.xsd"));
    }
